Products Grid
====u can buy all sorts of ascii faces like

This is an ecommerce site, where yo `(ノ・∀・)ノ` and `¯_(ツ)_/¯`, in a wide variety of font sizes. The homepage should display a list of products for people to browse.
